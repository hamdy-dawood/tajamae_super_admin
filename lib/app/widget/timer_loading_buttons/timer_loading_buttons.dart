...
class TimerLoadingButton extends StatefulWidget {
  final double height;
  final double width;
...
class TimerLoadingButtonState extends State<TimerLoadingButton>
      ...
      child: ButtonTheme(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            disabledIconColor: widget.disabledTextColor,
            overlayColor: widget.hoverColor,
            shadowColor: widget.highlightColor,
            foregroundColor: widget.focusColor,
            side: widget.borderSide,
...
class ArgonTimerButtonState extends State<ArgonTimerButton>
    with TickerProviderStateMixin {
  double? loaderWidth;
