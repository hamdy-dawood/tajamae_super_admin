...
class EventsModel extends EventsEntity {
  ...
  factory EventsModel.fromJson(Map<String, dynamic> json) => EventsModel(
    ...
    state: json['state'],
    description: json['description'] == null || json['description'].isEmpty ? "<p><br/></p>" : json['description'],
    ...
    thankYouConfirmed: json['thankYouConfirmed'] == null || json['thankYouConfirmed'].isEmpty ? "<p><br/></p>" : json['thankYouConfirmed'],
    thankYouPending: json['thankYouPending'] == null || json['thankYouPending'].isEmpty ? "<p><br/></p>" : json['thankYouPending'],
    qrCodeBanner: json['qrCodeBanner'],
    qrCodeNotes: json['qrCodeNotes'] == null || json['qrCodeNotes'].isEmpty ? "<p><br/></p>" : json['qrCodeNotes'],
    qrCodeTerms: json['qrCodeTerms'] == null || json['qrCodeTerms'].isEmpty ? "<p><br/></p>" : json['qrCodeTerms'],
    owner: json['owner'],
